{{-- <a href="{{ route('detail.produk', $item->id) }}" class="bg-blue-600 hover:bg-blue-300 rounded-full p-2">
...
<button onclick="openCreateModal()" class="bg-blue-600 hover:bg-blue-300 rounded-full p-2">
    <svg viewBox="0 0 24 24" class="w-5 h-5" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round">
        </g>
